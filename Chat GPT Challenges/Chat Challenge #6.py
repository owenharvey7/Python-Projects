...
# Ask user for their favorite movies in a loop. The user can input as many movies as they want until they say done.
while True:
...
# Enters the users name and favorite movies into a text file:
with open("Favorite Movies.txt", "w") as f:
    f.write(f"{Name}'s favorite movies are: {movies}")


# Prints the users name and favorite movies to the console:
